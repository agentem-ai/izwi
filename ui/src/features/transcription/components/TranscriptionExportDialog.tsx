...
} from "@/features/transcription/utils/transcriptionExport";
...
const FORMAT_OPTIONS: Array<{
...
}> = [
  {
    ...
    description: "Readable corrected transcript for sharing and document workflows.",
  },
  {
    value: "json",
    label: "JSON transcript",
    description: "Structured transcript with timing details for downstream systems.",
  },
  {
    value: "srt",
    label: "SRT captions",
    description: "Subtitle file for video and media publishing workflows.",
  },
  {
    value: "vtt",
    label: "VTT captions",
    description: "Web subtitle file for HTML5 video and browser playback.",
  },
];
      ...
      <DialogContent className="max-w-lg border-[var(--border-strong)] bg-[var(--bg-surface-0)]">
        <DialogHeader>
          ...
          <DialogDescription className="text-[var(--text-muted)]">
            Export corrected transcript text or timed subtitle files for downstream business workflows.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="flex items-center justify-between gap-3 rounded-xl border border-[var(--border-muted)] bg-[var(--bg-surface-1)] px-4 py-3">
            <div>
              ...
              <div className="text-xs text-[var(--text-muted)]">
                Add file, model, language, and timing details to TXT or JSON exports.
              </div>
            </div>
            <Switch
