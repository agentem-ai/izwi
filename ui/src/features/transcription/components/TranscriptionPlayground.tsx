...
export function TranscriptionPlayground({
  ...
  const [isTranscriptSessionActive, setIsTranscriptSessionActive] =
    useState(false);
  ...
  const handleReset = () => {
    ...
    setDetectedLanguage(null);
    setCurrentOutputRecord(null);
    setIsTranscriptSessionActive(false);
    setAudioUrl(null);
    setError(null);
    setProcessingStats(null);
    setIsStreaming(false);
  ...
  const workspaceShortcuts = useMemo(
    () => [
      ...
      },
      {
        ...
        shiftKey: true,
        enabled:
          !isHistoryModalOpen && isTranscriptSessionActive && !isRecording,
        action: handleReset,
      },
    ],
    [
  ...
  return (
    ...
    >
      <div className="space-y-4">
        <div
          data-testid="transcription-session-panel"
          className={cn(
            isInactiveSessionLayout
              ? "space-y-5 bg-transparent p-0"
              : "rounded-xl border border-[var(--border-muted)] bg-[var(--bg-surface-0)] p-4 sm:p-5 space-y-4",
          )}
        >
          <div
            className={cn(
          ...
          <div
            data-testid="transcription-settings-surface"
            className={cn(
              "space-y-3.5",
              isInactiveSessionLayout
          ...
          >
            ...
            <div
              className={cn(
                ...
                isInactiveSessionLayout
                  ? "pt-1"
                  : "border-t border-[var(--border-muted)] pt-3.5",
              )}
            >
          ...
          {canResetSession ? (
            <div
              data-testid="transcription-reset-rail"
      ...
      <div
        className={cn(
          ...
          isTranscriptSessionActive ? "xl:col-start-2" : "mx-1",
        )}
      >
